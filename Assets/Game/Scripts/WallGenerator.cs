...
{
    public static void CreateWalls(HashSet<Vector2Int> floorPositions, TilemapVisulizer tilemapVisualizer)
    {
    ...
    private static HashSet<Vector2Int> FindWallsInDirections(HashSet<Vector2Int> floorPositions, List<Vector2Int> directions)
    {
        ...
        { 
            foreach(var direction in directions)
            {
                ...
                if (floorPositions.Contains(neighbourPosition) == false) wallPositions.Add(neighbourPosition);
            }
        }
